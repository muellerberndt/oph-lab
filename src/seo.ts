...
const ROUTE_DESCRIPTIONS: Record<string, string> = {
  ...
  '/resources': 'Find the five-paper OPH stack, book, study surfaces, coherence map, OMEGA hardware guide, extra demos, challenge, and supporting reading for deeper study of Observer Patch Holography.',
};
