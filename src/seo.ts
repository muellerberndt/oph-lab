...
const DEFAULT_DESCRIPTION =
  'Interactive guide to OPH as observer-based fixed-point consensus, mapping the declared theorem surfaces across quantum gravity, Standard Model unified with gravity routes, the cosmological constant derivation, particles, records, and screen microphysics.';

const DEFAULT_TITLE = 'OPH Lab | Declared OPH Paper Surface';
const SITE_SUFFIX = ' | OPH Lab';

const ROUTE_DESCRIPTIONS: Record<string, string> = {
  '/': 'Explore the OPH fixed-point consensus surface: inspect screen capacity, the candidate pixel constant P, gravity, de Sitter, electroweak comparison rows, Higgs/top, and tiered particle surfaces.',
  ...
  '/de-sitter': 'Explore the OPH treatment of de Sitter space, cosmological horizons, and the cosmological constant derivation as a screen-capacity branch.',
