...
const ROUTE_DESCRIPTIONS: Record<string, string> = {
  ...
  '/resources': 'Find the five-paper OPH stack, book, blog, search-entry pages, coherence map, applications page, extra demos, challenge, and supporting reading for deeper study of Observer Patch Holography.',
};
