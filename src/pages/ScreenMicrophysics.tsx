    ...
    return (
        <div>
            ...
            <p style={{ marginBottom: '16px' }}>
                This is the concrete implementation surface of OPH. Instead of speaking only about abstract patches and
                overlaps, the microphysics paper writes them into one finite screen model with local registers, record
                qubits, repair instruments, and synchronization rules.
            </p>
            ...
            <Explainer title="What is already inside the paper">
                <p>
                    The paper packages measurement, stable records, checkpoint/restoration, and synchronization on a
                    finite screen architecture. It is not just a philosophical appendix to the rest of the OPH suite.
                </p>
                <p>
            ...
            <Explainer title="What remains outside the claim boundary">
                <p>
                    The paper does not claim to have found the final UV completion. It gives a workable reference
                    architecture and a theorem-ready fixed-cutoff surface.
                </p>
                <p>
                    It also does not close the continuum gravity bridge by itself. That later bridge remains part of
                    the broader OPH branch structure.
                </p>
            </Explainer>
        </div>
    );
